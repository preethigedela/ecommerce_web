...
private static CategoryDataset createDataset(){
	...
	for(int i=0;i<ReadDataset.chart.size();i++){
		String arr[] = ReadDataset.chart.get(i).split(",");
		localDefaultCategoryDataset.addValue(Double.parseDouble(arr[1]),arr[0],arr[0]);
	}
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Records Type", "Count", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
